            ...
            <div className='container mx-auto flex flex-row items-center justify-between'>
                ...
                <div className='flex flex-row items-center gap-4'>
                    <ul className='flex flex-row items-center gap-4 text-relazee-icon-nav text-xl'>
                        <li><Link href={'/home'} className={`w-10 h-10 rounded-md flex items-center justify-center ${pathname == '/home' ? 'bg-relazee-primary' : ''}`}><GoHomeFill /></Link></li>
                        ...
                        <li><Link href={'/home'} className={`w-10 h-10 rounded-md flex items-center justify-center ${pathname == '/events' ? 'bg-relazee-primary' : ''}`}><IoTrophy /></Link></li>
                        <li><Link href={'/home'} className={`w-10 h-10 rounded-md flex items-center justify-center ${pathname == '/events/add' ? 'bg-relazee-primary' : ''}`}><MdPostAdd /></Link></li>
                        <li>
                            <Link href={'/home'} className={`w-10 h-10 rounded-md flex items-center justify-center ${pathname == '/smartbot' ? 'bg-relazee-primary' : ''}`}>
