            ...
            <div className='container mx-auto flex flex-row items-center justify-between'>
                ...
                <div className='flex flex-row items-center gap-4'>
                    <ul className='flex flex-row items-center gap-4 text-relazee-icon-nav text-xl'>
                        <li><Link href={'/feed'} className={`w-10 h-10 rounded-md flex items-center justify-center ${pathname == '/feed' ? 'bg-relazee-primary' : ''}`}><GoHomeFill /></Link></li>
                        <li><Link href={'/partner'} className={`w-10 h-10 rounded-md flex items-center justify-center ${pathname == '/partner' ? 'bg-relazee-primary' : ''}`}><MdPersonSearch /></Link></li>
                        <li><Link href={'/feed'} className={`w-10 h-10 rounded-md flex items-center justify-center ${pathname == '/events' ? 'bg-relazee-primary' : ''}`}><IoTrophy /></Link></li>
                        <li><Link href={'/feed'} className={`w-10 h-10 rounded-md flex items-center justify-center ${pathname == '/events/add' ? 'bg-relazee-primary' : ''}`}><MdPostAdd /></Link></li>
                        <li>
                            <Link href={'/feed'} className={`w-10 h-10 rounded-md flex items-center justify-center ${pathname == '/smartbot' ? 'bg-relazee-primary' : ''}`}>
                ...
                <div className='flex flex-row items-center gap-4 text-relazee-icon-nav'>
                    <ul className='flex flex-row items-center gap-4 text-xl'>
                        <li><Link href={'/feed'} className='w-10 h-10 rounded-md bg-relazee-dark-3 flex items-center justify-center'><HiChatBubbleOvalLeftEllipsis /></Link></li>
                        <li><Link href={'/feed'} className='w-10 h-10 rounded-md bg-relazee-dark-3 flex items-center justify-center'><GoBellFill /></Link></li>
                    </ul>
